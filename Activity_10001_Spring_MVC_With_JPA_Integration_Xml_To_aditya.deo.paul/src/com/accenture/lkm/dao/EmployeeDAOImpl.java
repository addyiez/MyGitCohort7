...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public EmployeeBean updateEmployeeDetails(EmployeeBean employeeBean) throws Exception {
		...
		try {
			...
			EmployeeEntity employeeEntityBean2 = (EmployeeEntity) entityManager.find(EmployeeEntity.class,
					employeeBean.getId());
	...
	public List<EmployeeBean> getEmployeeList() throws Exception {
		...
		try {
			...
			List<EmployeeEntity> listEmployeeEntity = (List<EmployeeEntity>) entityManager
					.createQuery("from EmployeeEntity").getResultList();
