...
public class EmployeeDAOWrapper {
	...
	public List<EmployeeBean>findAll(){
		...
		listEn.forEach(x->{
			...
			BeanUtils.copyProperties(x, employee);//x is entity and employee is bean
			list.add(employee);
		});
		return list;
	}
	...
	public Integer saveEmployee(EmployeeBean employee){
		...
		BeanUtils.copyProperties(employee, employeeEntityBean);//employee is bean and employeeEntityBean is entity
