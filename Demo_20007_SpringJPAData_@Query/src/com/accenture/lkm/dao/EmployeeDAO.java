...
public interface EmployeeDAO {
	...
	//@Query("select count(k),k.role,sum(k.salary) from EmployeeEntity k group by k.role") 
	//@Query("select count(k),k.role,k.salary from EmployeeEntity k group by k.salary") 
	@Query("select count(k),k.role,avg(k.salary) from EmployeeEntity k group by k.role") 
