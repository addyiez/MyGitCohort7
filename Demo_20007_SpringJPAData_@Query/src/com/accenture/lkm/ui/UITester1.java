...
public class UITester1 {
	...
	public static void getAllEmployeeDetails1(EmployeeService serviceImpl) {
		...
		try {
			...
			List<EmployeeBean> listEmployeeBean = serviceImpl.getAllEmployeesBySalary(40000.0);
	...
	public static void getAllEmployeeDetails3(EmployeeService serviceImpl) {
		...
		try {
			...
			for(Object obj:list)//read/fetch employees from the list(list) and stores in Object(obj)
			{
