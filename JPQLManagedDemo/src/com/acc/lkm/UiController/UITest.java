...
public class UITest {
	...
	public static void main(String[] args) {
		try {
			...
			getEmployeeswithAssets("EarPhone");
		}catch(Exception ex) {
	...
	private static void getEmployeeswithAssets(String assetname) {
		try {
			EmployeeService service=Factory.createEmployeeService();
			service.getEmployeeWithAssets(assetname);
	...
	private static void getAllEmployeesAndAssetInnerJOIN() {
		try {
			EmployeeService service=Factory.createEmployeeService();
	...
	private static void getAllEmployeesAndAssetCascade() {
		try {
			EmployeeService service=Factory.createEmployeeService();
			service.getAllEmployeesAndAssetsCascade();
